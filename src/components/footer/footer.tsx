...
const Footer: React.FC = () => (
   <FooterContact id="contact">
      <TitleH2>Let’s <TitleH2span>work</TitleH2span> together!</TitleH2>
      <GetInTouchContainer>
         <GetInTouchLink href="mailto:tomasz.zwiazek0@gmail.com" rel="noopener noreferrer" target="_blank">
            Get in touch
         </GetInTouchLink>
      </GetInTouchContainer>
      {isMobile &&
         <SocialContainer type="bottom">
            <SocialLink href="https://drive.google.com/file/d/1XeCc5Z3QzYFuqIjTEBbWKEqEGgkwdqTz/view?usp=sharing" target="_blank" rel="noopener noreferrer">
               CV
            </SocialLink>
            ...
            <SocialLink href="https://github.com/tzwiazek" target="_blank" rel="noopener noreferrer">
